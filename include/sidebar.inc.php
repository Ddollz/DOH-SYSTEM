...
<div class="side-bar d-flex flex-column justify-content-center align-items-center">
    <ul class="side-bar-nav">
        <li class="nav-item mb-4 <?php echo (basename($_SERVER['PHP_SELF'],".php")=="system-ocr") ? "active" : ""?>">
            <a href="system-ocr.php" class="nav-link">
                <i class='bx bx-code-block'></i>
            </a>
        </li>
        <li class="nav-item mb-4 <?php echo (basename($_SERVER['PHP_SELF'],".php")=="system-discussion") ? "active" : ""?>">
